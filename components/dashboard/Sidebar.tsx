...
interface SidebarProps {
  activePage: 'dashboard' | 'orders' | 'campaigns' | 'settings' | 'profit' | 'attribution' | 'webhooks' | 'creatives' | 'ltv';
}
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.badge && (
                  <span className="ml-auto px-2 py-0.5 text-xs font-medium bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full">
                    {item.badge}
                  </span>
                )}
              </button>
