      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="space-y-12 text-white/70">
          ...
          <section>
            ...
            <p className="mb-4">
              These Terms of Service ("Terms") constitute a legally binding agreement between you and ARGORA ("we," "us," "our") concerning your access to and use of our abandoned cart recovery service for Shopify stores (collectively, the "Services").
            </p>
            <p className="mb-4">
          ...
          <section>
            ...
            <p className="mb-4">ARGORA offers a Pro Plan subscription:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong className="text-white">Pro Plan ($29.99/month):</strong> AI-powered abandoned cart recovery emails, unlimited carts, analytics dashboard, and email automation</li>
            </ul>
            ...
            <h3 className="text-xl font-bold text-white mb-3 mt-6">Cancellation</h3>
            <p>
              You may cancel your subscription at any time through your account settings. Cancellation takes effect at the end of your current billing period. You will retain access to paid features until that time.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Send spam or unsolicited emails through our Services</li>
          ...
          <section>
            ...
            <p className="mb-4">
              The Services, including all software, text, graphics, logos, and other content, are owned by ARGORA or our licensors and are protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              You retain ownership of any customer data, cart information, or other content accessed through the Services ("Your Content"). By using our Services, you grant us a worldwide, non-exclusive, royalty-free license to:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <p className="mb-4">
              Our Services integrate with third-party data providers (ATTOM, RentCast) and services (Anthropic Claude AI, Stripe). We are not responsible for:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <p className="mb-4 bg-gradient-to-br from-red-600/20 to-orange-600/20 backdrop-blur-sm border border-red-500/30 rounded-xl p-6">
              <strong className="text-white">IMPORTANT:</strong> ARGORA provides automated email services for abandoned cart recovery. We do NOT guarantee specific recovery rates or revenue results. Email delivery rates and customer responses vary based on many factors outside our control.
            </p>
            <p className="mb-4">
              When using our Services, you should:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>Comply with all applicable email marketing and privacy laws</li>
              <li>Ensure you have proper consent to email customers</li>
              <li>Monitor email performance and adjust strategies as needed</li>
              <li>Understand that AI-generated content may require review and editing</li>
            </ul>
            ...
            <p className="mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, ARGORA SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>Lost profits or revenue</li>
              <li>Loss of data or business interruption</li>
              <li>Errors or inaccuracies in email content</li>
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless ARGORA and its officers, directors, employees, and agents from any claims, liabilities, damages, losses, or expenses (including attorney's fees) arising from:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4 mt-4">
              <li>Your use of the Services</li>
              <li>Violation of these Terms</li>
              <li>Violation of any rights of another party</li>
              <li>Investment decisions made based on our Services</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              Before filing a claim, you agree to contact us at <a href="mailto:support@argora.ai" className="text-purple-400 hover:text-purple-300">support@argora.ai</a> to attempt to resolve the dispute informally.
            </p>

            <h3 className="text-xl font-bold text-white mb-3 mt-6">Binding Arbitration</h3>
            <p className="mb-4">
              Any disputes that cannot be resolved informally shall be resolved through binding arbitration in accordance with the American Arbitration Association's rules. Arbitration will be conducted in the United States.
            </p>
          ...
          <section>
            ...
            <p>
              These Terms, together with our Privacy Policy, constitute the entire agreement between you and ARGORA regarding the Services.
            </p>
          ...
          <section>
            ...
            <div className="bg-gradient-to-br from-purple-600/10 to-blue-600/10 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <p className="mt-2">Email: <a href="mailto:support@argora.ai" className="text-purple-400 hover:text-purple-300">support@argora.ai</a></p>
              <p>Legal: <a href="mailto:legal@argora.ai" className="text-purple-400 hover:text-purple-300">legal@argora.ai</a></p>
            </div>
          </section>
        </div>
